...
function GalleryItem({ image, getGallery }) {
  ...
  const thumbIcon = <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
  ...
  return (
    <>
      ...
      <button className="GalleryItem-button btn btn-primary">{thumbIcon} Click here to like!</button>
